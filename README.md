...
3. Search any city or zip code to see current conditions, radar, and the forecast.
...
- 🔒 **No Email Access**: The sidebar never reads the subject or body of any message. It only uses the location you search or save.
